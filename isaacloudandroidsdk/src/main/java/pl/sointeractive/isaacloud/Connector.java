...
public class Connector {
	 ...
	 *            Version of the API.
	 * @param config
	 *            Configuration parameters. Requires "gamificationId" and
	 *            "appSecret" keys and their respective values.
	 * @throws InvalidConfigException
	 *             Thrown when "gamificationId" or "appSecret" are not found in
	 *             the parameters.
	 */
	 ...
	 *             Thrown when an invalid query parameter is detected in the
	 *             request call.
	 * @throws InvalidRequestMethodException
	 *             Thrown when an unrecognized request method is used.
	 * @throws BadRequestException
	 *             Thrown when the request syntax is somehow malformed and
	 *             cannot be processed by the server.
	 * @throws UnauthorizedException
	 *             Thrown when the user lacks authorization to access resources.
	 * @throws LimitReachedException
	 *             Thrown when the user has reached the limit of the specified
	 *             resource.
	 * @throws ElementNotFoundException
	 *             Thrown when the no resource is found under the specified URI.
	 * @throws FatalServerErrorException
