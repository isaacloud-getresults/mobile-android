...
public class Isaacloud extends Connector {
	...
	public class Caller {
		 ...
		 * @param offset
		 *            starting point for the returned results
		 * @return updated Caller object
		 */
		 ...
		 * 
		 * @param order
		 *            list of tuples in form of (fieldName, ASC or DESC)
		 * @return updated Caller object
		 */
		 ...
		 * 
		 * @param query
		 *            list of tuples in form of (fieldName,fieldValue)
		 * @return updated Caller object
		 */
	 ...
	 * 
	 * @param subjectId
	 *            subject Id, id of resource
	 * @param subjectType
	 *            GROUP or USER
	 * @param priority
	 *            PRIORITY_LOW, PRIORITY_MEDIUM, PRIORITY_NORMAL, PRIORITY_HIGH,
	 *            PRIORITY_CRITICAL, PRIORITY_BLOCKER
	 * @param sourceId
	 *            transaction source id
	 * @param type
	 *            NORMAL, GROUP, DEBUG, FORCED
	 * @param body
	 *            event body
